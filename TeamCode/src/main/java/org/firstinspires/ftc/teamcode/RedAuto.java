...
//        rightArm1.setMode(DcMotor.RunMode.RUN_TO_POSITION);
        ...
        switch(position) {
            case 0:
                ...
                // Turning Right (Change values in the while loop below to change duration)
                leftFront.setPower(.3);
                rightFront.setPower(-.3);
                leftBack.setPower(-.3);
                rightBack.setPower(.3);
                ...
                // Strafing for a 100 clicks (Negate the values to go in the other direction) (Change values in the while loop below to change duration)
                leftFront.setPower(-.3);
                rightFront.setPower(-.3);
                leftBack.setPower(-.3);
                rightBack.setPower(-.3);
                ...
                // Turning Right, change value in the while loop below to change duration
                leftFront.setPower(-.3);
                rightFront.setPower(.3);
                leftBack.setPower(-.3);
                rightBack.setPower(.3);
            ...
            case 1:
                ...
                // Turning Left (change values in the while loop below to change duration)
                leftFront.setPower(.3);
                rightFront.setPower(-.3);
                leftBack.setPower(.3);
                rightBack.setPower(-.3);
                ...
                // Strafing (Negate values to go the other way) (Change values in the while loop to change duration)
                leftFront.setPower(.3);
                rightFront.setPower(-.3);
                leftBack.setPower(-.3);
                rightBack.setPower(.3);
            ...
            case 2:
                ...
                while(Math.abs(leftFront.getCurrentPosition()) < 925) {};
                ...
                while(Math.abs(leftFront.getCurrentPosition()) < 1875) {};
